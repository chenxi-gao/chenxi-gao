...
NAME="Yersinia"  # in future, we will define this as part of a config file
SRR_ID=SRR26255229  # in future, we will define this as part of a config file
...
mkdir data/raw_data/$NAME
mkdir data/trimmed_data/$NAME
mkdir data/assembled_data/$NAME
