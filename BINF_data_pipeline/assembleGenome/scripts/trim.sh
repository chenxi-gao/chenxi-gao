...
function trim {
    ...
    $DATA_PATH/trimmed_data/${NAME}/${SRR_ID}.R1.paired.fastq \
    $DATA_PATH/trimmed_data/${NAME}/${SRR_ID}.R1.unpaired.fastq \
    $DATA_PATH/trimmed_data/${NAME}/${SRR_ID}.R2.paired.fastq \
    $DATA_PATH/trimmed_data/${NAME}/${SRR_ID}.R2.unpaired.fastq \
    HEADCROP:0 \
